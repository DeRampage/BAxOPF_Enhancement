...
switch _mode do
{
    case "onLoad":
    {
        ...
        _SetInsiButton          = _display displayCtrl IDC_DYNAMICGROUPS_TF47_SetInsiBtn;
        _SetGrpButton           = _display displayCtrl IDC_DYNAMICGROUPS_TF47_SetGrpBtn;
        ...
        _SetGrpButton ctrlAddEventHandler ["ButtonClick", { with uiNamespace do { ["CloseDisplay"] call DISPLAY;};createDialog  "Rsctf47_DynGrp_setGrp";}];
    ...
    case "GetDisplay" :
    {
        uiNamespace getVariable [VAR_UI_DISPLAY, displayNull];
    };
    ...
    case "CloseDisplay" :
    {
        (uiNamespace getVariable [VAR_UI_DISPLAY, displayNull]) closeDisplay IDC_CANCEL;
    };
    ...
    case "UpdateManageSection" :
    {
        ...
        [
            ...
            "_fillPlayerUniform", "_fillPlayerFreq"
        ];
        _sectionManage          = _display displayCtrl IDC_DYNAMICGROUPS_SECTIONMANAGE;
        ...
        _fillPlayerUniform      = _display displayCtrl IDC_DYNAMICGROUPS_TEXTPLAYERSIDEFILL;
        _fillPlayerFreq         = _display displayCtrl IDC_DYNAMICGROUPS_TEXTPLAYERSCOREFILL;
        _fillPlayerRole         = _display displayCtrl IDC_DYNAMICGROUPS_TF47_Roletxt;
        _SetInsiButton          = _display displayCtrl IDC_DYNAMICGROUPS_TF47_SetInsiBtn;
        _SetGrpButton           = _display displayCtrl IDC_DYNAMICGROUPS_TF47_SetGrpBtn;
        ...
        if (_playerIsLeader) then {
            _SetInsiButton ctrlEnable true;
            _SetGrpButton ctrlEnable true;
        }
        else{
            _SetInsiButton ctrlEnable false;
            _SetGrpButton ctrlEnable false;
        };
        ...
        if (!_playerGroupRegistered) then
        {
            ...
            _fillPlayerUniform ctrlSetText "-";
            _fillPlayerFreq ctrlSetText "-";
            _fillPlayerRole ctrlSetText "-";
        ...
        else
        {
            ...
            _fillPlayerUniform ctrlSetText (gettext(configfile >> "CfgWeapons" >> (uniform _groupLeader) >> "displayName")); // old (["GetSideFormattedString", [_groupSide]] call DISPLAY);
            _fillPlayerFreq ctrlSetText _groupFreq; // old str score player;
            _fillPlayerRole ctrlSetText _groupRolename; 
    ...
    case "FillGroupsListbox" :
    {
        ...
        // Add them to the list box
        {
            ...
            private ["_groupName", "_groupPicture", "_groupIsPrivate", "_groupLeader", "_groupPlayers", "_groupRole","_groupRolename", "_wasKickedFrom", "_locked", "_maxUnitCount", "_isFull", "_autoName", "_groupNameRole"];
            ...
            _groupRole      = _x getVariable [VAR_GROUP_ROLE, ""];
            _groupRolename  = getText (configfile >> "CfgMarkers" >> _groupRole >> "Name");
            ...
            _groupNameRole  = format ["%1 | %2", _groupName, _groupRolename];
            _autoName       = if (_maxUnitCount < 99) then { format ["%1  (%2/%3)", _groupNameRole, count units _x, missionNamespace getVariable [VAR_MAX_UNITS_PER_GROUP, 99]] } else { _groupNameRole };
    ...
    case "OnManageLbSelChanged" :
    {
        ...
        if (_clickedPlayer == player) then
        {
            ...
            else
            {
                ...
                {
                    _buttonPromoteDisband ctrlEnable false/*!(missionNamespace getVariable [VAR_MINIMAL_INTERACTION, false])*/;
                    _buttonPromoteDisband ctrlSetText localize "STR_A3_RscDisplayDynamicGroups_Button_Disband";
                    _buttonPromoteDisband ctrlSetTooltip localize "STR_A3_RscDisplayDynamicGroups_Tooltip_KickAll";
                };
            };
    ...
    case "SetGroupName" :
    {
        ...
        {
            // Lose focus
            ctrlSetFocus ((uiNamespace getVariable [VAR_UI_DISPLAY, displayNull]) displayCtrl IDC_DYNAMICGROUPS_LISTBOXMANAGE);
    ...
    case "OnGroupNameChanged" :
    {
        ...
        _backgroundGroupName = (uiNamespace getVariable [VAR_UI_DISPLAY, displayNull]) displayCtrl IDC_DYNAMICGROUPS_BACKGROUNDGROUPNAME;
