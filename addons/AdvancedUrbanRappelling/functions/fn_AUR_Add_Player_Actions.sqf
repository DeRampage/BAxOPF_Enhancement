...
player addAction [localize "STR_TF47_AdvancedUrbanRappelling_Pick_Rappel_Point", { 
...
player addAction [localize "STR_TF47_AdvancedUrbanRappelling_Pack_Rope", {
