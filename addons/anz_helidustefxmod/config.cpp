...
class CfgPatches
{
    class ANZ_HeliDustEfxMod
    {
        author = "ANZACSAS Steve";
        name = "Helicopter Dust Efx Mod";
        requiredAddons[] = {"A3_Map_Data","A3_Map_Data_Exp","A3_Map_Enoch_Data","A3_Data_F_ParticleEffects"};
        requiredVersion = 0.1;
        units[] = {};
        weapons[] = {};
    };
...
class CfgCloudlets
{
    ...
    class HDust1: Default
    {
        ...
        colorCoef[] = {1,1,1,"0.5*((density*1.8) interpolate [0,0.6,0,0.6])"};
        animationSpeed[] = {1000};
    ...
    class HDust1Long: Default
    {
        ...
        colorCoef[] = {1,1,1,"0.02*((density*1.8) interpolate [0,0.6,0,0.6])"};
        animationSpeed[] = {1000};
        animationSpeedCoef = 1;
        randomDirectionPeriod = 0.1;
    ...
    class HWater3: Default
    {
        ...
        colorCoef[] = {1,1,1,"12 * ((density*1.7) interpolate [0,0.6,0,0.6]) * ((density*2.7) interpolate [0,0.6,0,0.6])"};
        animationSpeed[] = {1};
        animationSpeedCoef = 1;
        randomDirectionPeriod = 0.1;
