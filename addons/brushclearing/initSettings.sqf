[
    ...
    "Does a player require an entrenching Tool in its inventory for brush clearing?"],
    "TF47 Brush & Tree Clearing", // Pretty name of the category where the setting can be found. Can be stringtable entry.
